...
3. To run unit tests simply use the below command after filling in all the code:
...
def exercise10():
    ...
    factor4 = 4
    factor5 = 5
    product = factor1 * factor5 * factor4 * factor3 * factor2
    # ------ Place code above here /\ /\ /\ ------
